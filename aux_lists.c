...
/**
 * add_sep_end - adds the separator found at the end
 * of a sep_list.
...
/**
 * free_sep_lists - frees from a sep_list
 * @head: the head of the linked list.
 * Return: no return.
 */
...
/**
 * _free_line_list - frees a line_list
 * @head: head of the linked list.
 * Return: no return.
 */
void _free_line_list(line_list **head)
{
	line_list *temp;
	line_list *curr;
